...
class CfgFunctions {
	class FCLA_Immersions {
		...
		#include "\FCLA_Immersions\No_Aircraft_Bouncing\CfgFunctions.hpp"
...
class CfgVehicles {
	...
	#include "\FCLA_Immersions\No_Aircraft_Bouncing\CfgVehicles.hpp"
...
class CfgWeapons {
	...
	#include "\FCLA_Immersions\Reload_Launchers\CfgWeapon.hpp"
};
