...
if (hasInterface) then {
  ...
  ["visionMode", {
    ...
    if ((!FCLA_Modify_Color_NVG) || (isNull findDisplay 46) || (_newVisionMode != 1)) exitWith {[_unit, false] spawn FCLA_Effects_fnc_switchEffectNVG;};
  ...
  ["featureCamera", {
    ...
    if ((!FCLA_Modify_Color_NVG) || (isNull findDisplay 46) || (_newCameraMode != "")) exitWith {[_unit, false] spawn FCLA_Effects_fnc_switchEffectNVG;};
