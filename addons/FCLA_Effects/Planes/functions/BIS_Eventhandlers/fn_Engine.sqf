...
if (_engineState) then {
  _handle = [{
    ...
    if ((_speed >= 150) && ((_enginePower) >= 10)) then {[_plane, _engineOne, _engineTwo, _pos, _speed, _posASL, _posATL, _posASLW, _velocity] Spawn FCLA_Effects_fnc_groundSmokePlanes;};
