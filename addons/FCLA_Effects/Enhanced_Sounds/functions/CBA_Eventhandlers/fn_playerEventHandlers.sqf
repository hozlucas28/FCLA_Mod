...
["visionMode", {
  ...
  if (isNull objectParent player) then {[_unit, "FCLA_Vision_Mode_Changed", nil, 200, false] call FCLA_Common_fnc_globalSay3D;} else {playSound "FCLA_Vision_Mode_Changed";};
}, false] call CBA_fnc_addPlayerEventHandler;
