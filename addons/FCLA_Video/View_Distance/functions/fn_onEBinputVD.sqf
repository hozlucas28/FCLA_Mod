...
/* ----------------------------------------------------------------------------
Function: FCLA_Video_Settings_fnc_onEBinputVD
...
_viewDistValue = _textValue min FCLA_VD_maxView;
_objViewDistValue = if (_modeVar isEqualTo 1) then {_textValue  * (call compile _percentVar) min FCLA_VD_maxObj} else {_textValue min FCLA_VD_maxObj};
