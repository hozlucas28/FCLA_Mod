...
class Erlenmeyer_Flask: lab_Items_base_F {
  author = "hozlucas28";
...
class Volume_Beaker: lab_Items_base_F	{
  author = "hozlucas28";
  displayName = "Matraz";
  icon = "iconObject_circle";
...
class Triple_Beam: lab_Items_base_F {
  author = "hozlucas28";
...
class Microscope: lab_Items_base_F {
  author = "hozlucas28";
