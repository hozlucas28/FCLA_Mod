 ...
 *
 * Description:
 * Crea controladores de eventos públicos.
 *
 * Public: [No]
---------------------------------------------------------------------------- */
...
["FCLA_Switch_Lights", {{[_x, _this select 1] call BIS_fnc_switchLamp;} forEach (_this select 0);}] call CBA_fnc_addEventHandler;
