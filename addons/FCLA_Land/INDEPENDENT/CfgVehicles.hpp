...
class FCLA_I_Van_02_Transport_F: C_Van_02_transport_F {
  ...
  hiddenSelectionsTextures[] = {"\FCLA_Land\INDEPENDENT\data\FCLA_I_Van_02_Transport_F.paa", "\a3\soft_f_orange\van_02\data\van_wheel_co.paa", "\a3\soft_f_orange\van_02\data\van_glass_transport_ca.paa", "\FCLA_Land\INDEPENDENT\data\FCLA_I_Van_02_Transport_F.paa"};
  side = 2;
  faction = "IND_F";
...
class FCLA_I_Van_02_Vehicle_F: C_Van_02_vehicle_F {
  ...
  hiddenSelections[] = {"camo1", "camo2", "camo3", "emergency_lights"};
  hiddenSelectionsTextures[] = {"\FCLA_Land\INDEPENDENT\data\FCLA_I_Van_02_Vehicle_F.paa", "\a3\soft_f_orange\van_02\data\van_wheel_co.paa", "\a3\soft_f_orange\van_02\data\van_glass_utility_ca.paa", "\FCLA_Land\INDEPENDENT\data\FCLA_I_Van_02_Vehicle_F.paa"};
  side = 2;
  faction = "IND_F";
  editorSubcategory = "EdSubcat_Cars";
  scope = 2;
...
class FCLA_I_Van_02_Service_F: C_Van_02_service_F {
  ...
  hiddenSelections[] = {"camo1", "camo2", "camo3", "emergency_lights"};
  hiddenSelectionsTextures[] = {"\FCLA_Land\INDEPENDENT\data\FCLA_I_Van_02_Service_F.paa", "a3\soft_f_orange\van_02\data\van_wheel_dirty_co.paa", "a3\soft_f_orange\van_02\data\van_glass_civservice_ca.paa", "a3\soft_f_orange\van_02\data\van_body_civservice_co.paa"};
  side = 2;
  faction = "IND_F";
  editorSubcategory = "EdSubcat_Cars";
  scope = 2;
