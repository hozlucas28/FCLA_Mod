...
[{
  _isEOD = [_args, "EOD"] call FCLA_Common_fnc_checkUnitTrait;
  _isDoctor = [_args, "Doctor"] call FCLA_Common_fnc_checkUnitTrait;
  _isAdvancedEnginner = [_args, "Advanced Enginner"] call FCLA_Common_fnc_checkUnitTrait;
  ...
  if (isNull findDisplay 10001) exitWith {["FCLA_Hint_Silent", [""], _args] call CBA_fnc_targetEvent; [_handle] call CBA_fnc_removePerFrameHandler;};
  ...
  ], _args] call CBA_fnc_targetEvent;
