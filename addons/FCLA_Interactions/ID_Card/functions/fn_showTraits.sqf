...
[{
  ...
  if (isNull findDisplay 10001) exitWith {["FCLA_Hint_Silent", [""], _this select 0] call CBA_fnc_targetEvent; [_handle] call CBA_fnc_removePerFrameHandler;};
  ...
  ], _this select 0] call CBA_fnc_targetEvent;
