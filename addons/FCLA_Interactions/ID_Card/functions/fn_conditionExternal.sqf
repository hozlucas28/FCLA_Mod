...
(FCLA_ID_Card_Allowed) && (_notInStairs) && ((_areFriendly) || (_isHandcuffed) || (_isTargetSurrendering)) && (_isNotDragging) && (_isNotCarrying) && (_areNotSwimming) && (_isTouchingGround) && (_isNotSurrendering) && (_notInWeaponAnimation)
