...
class FCLA_Put_Arid_Camo_Net {
  ...
  statement = "[_player] call FCLA_Interactions_fnc_statementPutAridHCN;";
...
class FCLA_Put_Tropical_Camo_Net {
  ...
  statement = "[_player] call FCLA_Interactions_fnc_statementPutTropicalHCN;";
  displayName = "Colocar camuflaje<br/>(casco)";
};
...
class FCLA_Remove_Camo_Net {
  ...
  statement = "[_player] call FCLA_Interactions_fnc_statementRemoveHCN;";
