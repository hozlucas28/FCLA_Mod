...
(FCLA_Blindfold_Allowed) && (_isAlive) && (_notInStairs) && (_isNotSwimming) && (_isNotDragging) && (_isNotCarrying) && (_isTouchingGround) && (_isNotSurrendering) && (_hasBandageEquipped) && (_notInWeaponAnimation)
