...
_coefficientOfDamage = _getChemicalDamage / FCLA_CBRN_Maximum_Chemical_Damage;
[_patient, "quick_view", "%1 verificando la exposición química", [name _player]] call ACE_Medical_Treatment_fnc_addToLog;
...
switch (true) do {
  case ((_coefficientOfDamage >= 0) && (_coefficientOfDamage <= 0.1)): {
    ...
    [_patient, "quick_view", "%1 verifico la exposición química: Nula", [name _player]] call ACE_Medical_Treatment_fnc_addToLog;
  };
  ...
  case ((_coefficientOfDamage > 0.1) && (_coefficientOfDamage <= 0.4)): {
    ...
    [_patient, "quick_view", "%1 verifico la exposición química: Baja", [name _player]] call ACE_Medical_Treatment_fnc_addToLog;
  };
  ...
  case ((_coefficientOfDamage > 0.4) && (_coefficientOfDamage <= 0.9)): {
    ...
    [_patient, "quick_view", "%1 verifico la exposición química: Media", [name _player]] call ACE_Medical_Treatment_fnc_addToLog;
  };
  ...
  default {
    ...
    [_patient, "quick_view", "%1 verifico la exposición química: Alta", [name _player]] call ACE_Medical_Treatment_fnc_addToLog;
  };
};
