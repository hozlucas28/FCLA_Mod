...
(FCLA_Share_Map_Allowed) && (_isOnMap) && (_notInVehicle) && (_isNotDragging) && (_isNotCarrying) && (_isNotSwimming) && (_isNotSharingMap) && (_isTouchingGround) && (_hasCompatibleMap) && (_isNotSurrendering)
