...
(FCLA_Share_Map_Allowed) && (_isOnMap) && (_notInStairs) && (_notInVehicle) && (_isNotDragging) && (_isNotCarrying) && (_isNotSwimming) && (_isNotSharingMap) && (_isNotHandcuffed) && (_isTouchingGround) && (_hasCompatibleMap) && (_isNotSurrendering)
