...
(FCLA_Share_Map_Allowed) && (_areNear) && (_isAlive) && (_notInStairs) && (_areFriendly) && (_isSharingMap) && (_isNotDragging) && (_isNotCarrying) && (_areNotSwimming) && (_isNotHandcuffed) && (_isTouchingGround) && (_areNotSurrendering) && (_hasNotCompatibleMap) && (_notInWeaponAnimation)
