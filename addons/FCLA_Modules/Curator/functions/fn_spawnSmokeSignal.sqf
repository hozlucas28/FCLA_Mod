...
["FCLA", "Generar senal de humo", {
  ["Senal de humo",
	 [
    ["SLIDER", ["Altura", "Altura a la que generara el humo de la senal, respecto del suelo"],
     [
      5,
      100,
      20,
	 ...
	 ],
   {
     ...
     ["SENAL DE HUMO GENERADA"] call ZEN_Common_fnc_showMessage;
