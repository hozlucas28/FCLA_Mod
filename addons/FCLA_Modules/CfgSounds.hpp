...
class FCLA_Wind_Gust_1 {
  ...
  sound[] = {"\FCLA_Modules\sounds\Wind_Gust_1.ogg", 0.5, 1};
  titles[] = {0, ""};
};

class FCLA_Wind_Gust_2 {
  name = "FCLA - Ráfaga de viento (2)";
  sound[] = {"\FCLA_Modules\sounds\Wind_Gust_2.ogg", 0.5, 1};
  titles[] = {0, ""};
};

class FCLA_Wind_Gust_3 {
  name = "FCLA - Ráfaga de viento (3)";
  sound[] = {"\FCLA_Modules\sounds\Wind_Gust_3.ogg", 0.5, 1};
  titles[] = {0, ""};
};

class FCLA_Wind_Gust_4 {
  name = "FCLA - Ráfaga de viento (4)";
  sound[] = {"\FCLA_Modules\sounds\Wind_Gust_4.ogg", 0.5, 1};
  titles[] = {0, ""};
};

class FCLA_Wind_Gust_5 {
  name = "FCLA - Ráfaga de viento (5)";
  sound[] = {"\FCLA_Modules\sounds\Wind_Gust_5.ogg", 0.5, 1};
  titles[] = {0, ""};
};

class FCLA_Wind_Gust_6 {
  name = "FCLA - Ráfaga de viento (6)";
  sound[] = {"\FCLA_Modules\sounds\Wind_Gust_6.ogg", 0.5, 1};
  titles[] = {0, ""};
};

class FCLA_Wind_Gust_7 {
  name = "FCLA - Ráfaga de viento (7)";
  sound[] = {"\FCLA_Modules\sounds\Wind_Gust_7.ogg", 0.5, 1};
  titles[] = {0, ""};
};
