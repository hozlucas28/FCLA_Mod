...
if (_moreThanOne) exitWith {["FCLA_Module_Save_Loadout", "• MÓDULO: GUARDAR ULTIMO EQUIPAMIENTO", "¡Error! Solo puede haber un módulo de este tipo. Los módulos 'Guardar ultimo equipamiento' han sido desactivados."] call FCLA_Common_fnc_errorMessage;};
if (_missionID == "") exitWith {["FCLA_Module_Save_Loadout", "• MÓDULO: GUARDAR ULTIMO EQUIPAMIENTO", "¡Error! El módulo 'Guardar ultima ubicación' no se pudo inicializar con éxito."] call FCLA_Common_fnc_errorMessage;};
