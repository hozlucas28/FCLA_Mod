...
if ((_newAge == "") || (_newName == "") || (_newPlaceOfBirth == "") || (_areNotCompatibleSynchronizedObjects)) exitWith {["¡Error! El/Un módulo 'Modificar ID' no se pudo inicializar con éxito."] call BIS_fnc_error;};
