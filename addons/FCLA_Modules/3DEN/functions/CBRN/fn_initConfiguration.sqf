...
if ((_compatibleOxygenMasks isEqualTo []) && (_compatibleChemicalDetectors isEqualTo []) && (_compatibleBackpacksWithOxygen isEqualTo [])) exitWith {["¡Error! El/Un módulo 'Dispositivo hackeable' no se pudo inicializar con éxito."] call BIS_fnc_error;};
