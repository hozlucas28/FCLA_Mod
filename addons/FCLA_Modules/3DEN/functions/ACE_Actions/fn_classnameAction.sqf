...
if ((_name == "") || (_condition == "") || (_statement == "") || (_parentPath == "") || (_typeOfAction <= -1)) exitWith {["¡Error! El/Un módulo 'Crear acción (ACE - classname)' no se pudo inicializar con éxito."] call BIS_fnc_error;};
