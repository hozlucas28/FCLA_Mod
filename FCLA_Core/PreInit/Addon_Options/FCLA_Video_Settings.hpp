...
[
	...
	true,
	GLOBAL,
	{[format ["FCLA Interactions (addon options) - Is view distance allowed? = %1.", _this]] remoteExec ["diag_log", 2];},
	true
...
[
	...
	LOCAL,
	{
		...
		_name = name player;
		[format ["FCLA Interactions (addon options) - %1 tiene activado la distancia de visión avanzada.", _name]] remoteExec ["diag_log", 2];
	},
	false
] call CBA_fnc_addSetting;
